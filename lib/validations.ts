...
export const UPLOAD_LIMITS = {
  image: {
    ...
    label: 'รูปภาพ (jpg/png/heic/webp) ขนาดไม่เกิน 25MB ต่อรูป ไม่เกิน 5 รูป',
  },
  video: {
    maxCount: 1,
  ...
  /**
   * เพดานรวมทั้งคำขอ — กันหน่วยความจำหมด เพราะ saveUpload() อ่านไฟล์เข้าหน่วยความจำทั้งก้อน
   * ด้วยเพดานปัจจุบัน (5 รูป × 25MB + คลิป 50MB = 175MB) ค่านี้จะไม่ถูกแตะเลย
   * มีไว้เป็นตาข่ายสำหรับวันที่มีคนเพิ่ม maxCount หรือ maxSize แล้วลืมคิดถึงขนาดรวม
   */
